...
#ifndef LEVELDB_ITEMS_H
#define LEVELDB_ITEMS_H
 ...
 */
void item_release(struct leveldb_engine *engine, hash_item *it);
 ...
 */
void item_unlink(struct leveldb_engine *engine, hash_item *it);
