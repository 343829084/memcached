 ...
 */
static int do_slabs_newslab(struct leveldb_engine *engine, const unsigned int id);
static void *memory_allocate(struct leveldb_engine *engine, size_t size);
...
static int grow_slab_list (struct leveldb_engine *engine, const unsigned int id) {
...
/*@null@*/
static void *do_slabs_alloc(struct leveldb_engine *engine, const size_t size, unsigned int id) {
    slabclass_t *p;
    void *ret = NULL;
...
static void do_slabs_free(struct leveldb_engine *engine, void *ptr, const size_t size, unsigned int id) {
    slabclass_t *p;
...
/*@null@*/
static void do_slabs_stats(struct leveldb_engine *engine, ADD_STAT add_stats, const void *cookie) {
    int i, total;
...
void *slabs_alloc(struct leveldb_engine *engine, size_t size, unsigned int id) {
    void *ret;
