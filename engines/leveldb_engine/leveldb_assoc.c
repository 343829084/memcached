...
hash_item *assoc_find(struct leveldb_engine *engine, uint32_t hash, const char *key, const size_t nkey) {
    hash_item *it;
...
static hash_item** _hashitem_before(struct leveldb_engine *engine,
                                    uint32_t hash,
                                    const char *key,
                                    const size_t nkey) {
    hash_item **pos;
...
static void assoc_expand(struct leveldb_engine *engine) {
...
int assoc_insert(struct leveldb_engine *engine, uint32_t hash, hash_item *it) {
    unsigned int oldbucket;
...
void assoc_delete(struct leveldb_engine *engine, uint32_t hash, const char *key, const size_t nkey) {
